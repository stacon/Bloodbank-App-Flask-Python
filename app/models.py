...
class User(db.Model):
    ...
    priviledges_level       = db.Column('priviledges_level', db.Integer(3), nullable=False)
...
class Bloodtype(db.Model):
    ...
    milliliters_available   = db.Column('milliliters_available',db.Integer(11), nullable=False)
...
class Donor(db.Model):
    ...
    milliliters_deposited   = db.Column('milliliters_deposited', db.Integer(4), nullable=True)
    milliliters_withdrawn   = db.Column('milliliters_withdrawn', db.Interger(4), nullable=True)
    soft_deleted            = db.Column('soft_deleted', db.TIMESTAMP(timezone=False), nullable=True)

class Transaction(db.Model):
    id                      = db.Column('id', db.Integer, primary_key=True)
    donor_id                = db.Column('donor_id', db.Integer(10), nullable=False)
